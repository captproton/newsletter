...
#     design { nil }
#     sequence { 1 }
#     published_at { "2022-06-25 10:12:32" }
#     updated_by { 1 }
#     deleted_at { "2022-06-25 10:12:32" }
#   end
# end
# 
...
FactoryBot.define do
  factory :newsletter, class: Newsletter::Newsletter do
    ...
    description {FFaker::Lorem.paragraphs(1).join("\n")[0..125]}
    association :design
    pieces do |newsletter|
      ...
      [ ::Newsletter::Piece.new(
        ...
        field_values_attributes: { image_field.id => {
          url: FFaker::Internet.url.gsub(%r#(/[^/]*\.[^/]*)?$#,'/bobo.jpg')
        }}
      )]
    end
    ...
    factory :newsletter_with_pdf_url do
      pieces do | newsletter | 
        ...
        [ ::Newsletter::Piece.new(
          ...
          element_id: left_image_element.id,
          field_values_attributes: { image_field.id => {
            url: FFaker::Internet.url.gsub(%r#(/[^/]*\.[^/]*)?$#,'/bobo.pdf')
          }}
        )]
      end
    end
